      ...
      <section className="hero">
        <div className="max-width hero-content">
          <h1 className="hero-h1 reveal">
            Practice for your <br /> <span className="text-gradient">final round.</span>
          </h1>
          ...
          <div className="reveal" style={{ animationDelay: '0.2s' }}>
            <Link to={isAuthenticated ? "/configure" : "/?auth=true"} className="btn-main">
              {isAuthenticated ? "Start Session" : "Join Today"}
