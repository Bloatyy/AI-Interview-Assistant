...
const companies = [
  ...
  { 
    ...
    logo: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
        <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.75.79-.01 2.04-.84 3.63-.67 1.49.16 2.62.77 3.34 1.83-3.07 1.83-2.58 5.86.53 7.15-.65 1.65-1.54 3.28-2.58 3.91zM12.03 7.25c-.02-2.23 1.82-4.04 4.02-4.14.23 2.61-2.4 4.41-4.02 4.14z"/>
      </svg>
    ), 
    desc: "Excellence" 
  },
  ...
  { 
    ...
    logo: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
        <path d="M4 2v20c1.071 0 1.913-.801 2.527-2.144L12 9.07l5.473 10.786c.614 1.343 1.456 2.144 2.527 2.144V2c-1.071 0-1.913.801-2.527 2.144L12 14.93 6.527 4.144C5.913 2.801 5.071 2 4 2z" fill="#E50914"/>
      </svg>
    ), 
    desc: "Scale" 
  },
  ...
  { 
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M17.523 15.3414c-.5511 0-.9992-.4481-.9992-.9992 0-.5511.4481-.9992.9992-.9992.5511 0 .9992.4481.9992.9992 0 .5511-.4481.9992-.9992.9992m-11.046 0c-.5511 0-.9992-.4481-.9992-.9992 0-.5511.4481-.9992.9992-.9992.5511 0 .9992.4481.9992.9992 0 .5511-.4481.9992-.9992.9992m11.4045-6.02l1.9973-3.4592c.1133-.1962.0462-.4473-.15-.5606-.1962-.1133-.4473-.0462-.5606.15l-2.0232 3.5042c-1.6156-.7388-3.4158-1.1541-5.3094-1.1541-1.8936 0-3.6938.4153-5.3094 1.1541l-2.0232-3.5042c-.1133-.1962-.3644-.2633-.5606-.15-.1962.1133-.2633.3644-.15.5606l1.9973 3.4592C4.1032 10.3601 2.3 12.7533 2.106 15.4851h19.788c-.194-2.7318-1.9972-5.125-4.7214-6.1637"/>
      </svg>
    ) 
  },
];
